...
NSString * const kDBZNeedPayOrderNote               = @"kDBZNeedPayOrderNote";
NSString * const kDBZWebSocketDidOpenNote           = @"kDBZWebSocketDidOpenNote";
NSString * const kDBZWebSocketDidCloseNote          = @"kDBZWebSocketDidCloseNote";
NSString * const kDBZWebSocketdidReceiveMessageNote = @"kDBZWebSocketdidReceiveMessageNote";
NSString * const kDBZWebSocketdidConnectFailed = @"kDBZWebSocketdidConnectFailed";
...
//        @property(nonatomic,copy)NSString * message;
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:kDBZWebSocketdidConnectFailed object:message];
        return;
    }
...
//        NSLog(@"************************** socket 连接成功************************** ");
        [[NSNotificationCenter defaultCenter] postNotificationName:kDBZWebSocketDidOpenNote object:nil];
    }
}
...
//        NSLog(@"message:%@",message);
        [[NSNotificationCenter defaultCenter] postNotificationName:kDBZWebSocketdidReceiveMessageNote object:message];
    }
}
